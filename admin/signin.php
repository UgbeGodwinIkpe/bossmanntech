                        ...
                        <div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-6">
                            <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <a href="../" class="">
                                        <!-- <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>BOSSMANN TECH</h3> -->
                                    </a>
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleCheck1">Have You Entered Your Correct Login Credentials?</label>
                                    </div>
